...
var BUSCAPE_PRODUTO_CONTROLE = document.getElementById('BUSCAPE_PRODUTO_CONTROLE').value;
...
var eBUSCAPE_CATEGORIA       = document.getElementById('BUSCAPE_CATEGORIA');
var BUSCAPE_CATEGORIA        = eBUSCAPE_CATEGORIA.options[eBUSCAPE_CATEGORIA.selectedIndex].value;

x_salvar_cadastro(BUSCAPE_PRODUTO_CONTROLE, PRODUTO_CONTROLE, VARIANTE_CONTROLE, CODIGO, LINK, BUSCAPE_CATEGORIA, volta_cadastro);

}

function volta_cadastro(cret) {
    alert('Informação gravada com sucesso.');
    document.getElementById('BUSCAPE_PRODUTO_CONTROLE').value = cret ;
